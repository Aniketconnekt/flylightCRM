...
namespace CRM.SuperAdmin.View.AddAdminCustomer
{
	[XamlCompilation(XamlCompilationOptions.Compile)]
	public partial class AddAdminCustomerPage : ContentPage
	{
        AddAdminCustomerViewModel _addAdminCustomerViewModel;
        bool Flag = true;
        AdminCustomerData _adminCustomerData = new AdminCustomerData();

        public AddAdminCustomerPage (AdminCustomerData adminCustomerData)
		{
            NavigationPage.SetBackButtonTitle(this, "");
            InitializeComponent();
            _adminCustomerData = adminCustomerData;
            BindingContext = _addAdminCustomerViewModel = new AddAdminCustomerViewModel(Navigation);
        }

        protected override void OnAppearing()
        {
            base.OnAppearing();
            _addAdminCustomerViewModel.Initialize(_adminCustomerData);
        }
